...
public class WorkflowAction {
  ...
  public WorkflowAction(@Qualifier("mainDomain") String mainDomain) {
  ...
  public ResponseEntity<String> action(
    ...
    transitionTheTask(
      jsonNode.get("transition-uri").asText(), transition,
      jwt.getTokenValue());
  ...
  private String decideHowToTransitionTheTask(JsonNode workflowPayload) {
    JsonNode nextTransitions = workflowPayload.get("next-transitions");
